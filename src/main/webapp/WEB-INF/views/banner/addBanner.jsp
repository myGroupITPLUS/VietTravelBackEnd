...
<jsp:include page="/WEB-INF/views/header.jsp">
        <jsp:param name="title" value="Thêm banner" />
    </jsp:include>
        ...
        <div class="row">
          <div class="col-12">
			 <div class="card card-primary">
              <!-- form start -->
              <form:form modelAttribute="bannerDTO" method="post" action="${pageContext.request.contextPath}/admin/banner/process-add" enctype="multipart/form-data">
                <div class="card-body">
