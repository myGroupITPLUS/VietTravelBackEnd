...
<jsp:include page="/WEB-INF/views/header.jsp">
        <jsp:param name="title" value="Cập nhật banner" />
    </jsp:include>
        ...
        <div class="row">
          <div class="col-12">
			 <div class="card card-primary">
              <!-- form start -->
              <form:form modelAttribute="bannerDTO" method="post" action="${pageContext.request.contextPath}/admin/banner/process-edit" enctype="multipart/form-data">
                <div class="card-body">
  				  <input type="hidden" value="${bannerDTO.id}" name="id">
                  <div class="form-group">
                    <label>Tên banner</label>
                    <input type="text" class="form-control" name="name" value="${bannerDTO.name}">
                  </div>
                  <div class="form-group">
                    <label>Mô tả</label>
                    <textarea class="form-control" rows="3" name="descriptions">${bannerDTO.descriptions}</textarea>
                  </div>
                  <div class="form-group">
                    <label>Url</label>
                    <input type="text" class="form-control" name="url" value="${bannerDTO.url}">
                  </div>
                  <div class="form-group">
