...
<jsp:include page="/WEB-INF/views/header.jsp">
        <jsp:param name="title" value="Quản lí Tour" />
    </jsp:include>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Quản lí Tour</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <c:set var="list" value="${requestScope.listTour}" />
			        <c:forEach var="tour" items="${list}">
			             <tr>
		                    <td>${tour.id}</td>
		                    <td>${tour.categoryid}</td>
		                    <td>${tour.promotionid}</td>
		                    <td>${tour.name}</td>
		                    <td>${tour.diemdi}</td>
		                    <td>${tour.diemden}</td>
		                    <td>${tour.timedi}</td>
