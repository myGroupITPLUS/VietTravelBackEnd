	...
	public List<Category> getAllCategory() {
		...
		List<Category> listCategory= jdbcTemplate.query(sqlString, new Object[] {},new RowMapper<Category>() {
			...
			public Category mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				category.setCategoryid(rs.getInt("macategory"));
				category.setCategoryname(rs.getString("tencategory"));
				category.setMota(rs.getString("mota"));
				category.setImg(rs.getString("anh"));
				return category;
			}
			});
		return listCategory;
